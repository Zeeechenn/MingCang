...
**v0.2.2（2026-06-03）** 已把 StockSage 从 A 股本地研究扩展到 A/HK/US 三市场的只读研究上下文：港股和美股可以进入行情、能力目录、数据质量检查和 agent 查询，但仍不参与官方交易信号或组合风控。

当前公开主线继续坚持“研究先行、交易保守”：A 股生产信号仍以技术面和新闻情绪为主，量化/Kronos 证据继续作为可审计研究线索沉淀，未通过完整验证门槛前不进入默认综合分。完整版本变更见 [CHANGELOG.md](CHANGELOG.md)。
