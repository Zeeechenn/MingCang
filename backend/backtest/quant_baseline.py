"""Canonical quant baseline validation and report implementation.

The workflow is local-only by default: it reads the production SQLite database,
...
human-readable report under ``~/.mingcang``.  The historical M26 tool module is
kept as a compatibility CLI.
"""
