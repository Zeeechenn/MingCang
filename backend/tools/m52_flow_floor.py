"""M52 flow-floor production provider for news fusion.

This module was designed in ``backend.data.news_fusion`` but never existed
(M61 audit D1). Scoring reads DB-only point-in-time fund-flow rows; collection
happens through ``m61_backfill`` category ``fund_flow``.
"""
