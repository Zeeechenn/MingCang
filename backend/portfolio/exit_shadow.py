...
adjudication candidate variant (3) -- trailing x3.5 + a 10%
retrace-from-peak floating take-profit (``ExitVariant(3.5, "drawdown_10")``)
-- is kept here only as a forward shadow comparison. The locked holdout review
through 2026-08-18 rejected promotion: baseline x2.5/none is retained, all
nonbaseline variants remain no-promotion, and the forward shadow evidence is
...
from backend.backtest.exit_sweep_m58 import (
    ExitVariant,
    _connect_readonly,
    _max_price_date,
...
# x3.5/drawdown_10 comparison candidate. Locked holdout evidence now rejects
# promotion of that candidate; nothing in this module accepts an alternate pair.
