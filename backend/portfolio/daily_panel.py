...
from backend.backtest.grid_backtest import regime_from_pool_equal_weight
...
from backend.decision.entry_card import build_entry_card, render_entry_card_compact
from backend.decision.readiness import build_readiness, render_readiness_line
